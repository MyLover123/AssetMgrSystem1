...
import org.service.impl.MyAssetServiceImpl;
...
@WebServlet(urlPatterns = "/myAsset.ajax")
public class MyAssetServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.setCharacterEncoding("utf-8");
        response.setCharacterEncoding("utf-8");
        String account = request.getParameter("account");
        MyAssetService as=new MyAssetServiceImpl();
        List<MyAsset> list = as.getAsset(account);
