...
import org.service.impl.AssetServiceImpl;
...
public class AssetServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        AssetService as=new AssetServiceImpl();
        List<Asset> list = as.getAsset();
...
//        AssetService asset = new AssetServiceImpl();
//        List<Asset> assets=asset.getAsset();
//        System.out.println(assets);
//
//        request.setAttribute("asset",assets);
//        request.getRequestDispatcher("assetTab.jsp").forward(request,response);
    }
}
