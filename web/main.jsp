            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                            <a url="myFinance.jsp" class="btn btn-link btn-block mybtn" role="button">我的财务</a>
                            <a url="financeTab.jsp" class="btn btn-link btn-block mybtn" role="button">财务列表</a>
                            <a url="financeEntry.jsp" class="btn btn-link btn-block mybtn" role="button">财务入账</a>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                        <div class="panel-body">
                            <a url="staffTab.jsp" class="btn btn-link btn-block mybtn" role="button">用户管理</a>
                        </div>
                    </div>
                </div>
            </div>
